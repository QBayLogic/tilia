...
builtinFixities =
  Map.fromList
    ...
    , entry "GHC.Internal.Bignum.Primitives"
        [("&&#", RightAssoc, 3), ("||#", RightAssoc, 2)]
    ...
    , entry "GHC.Internal.Data.List"
        [("!!", LeftAssoc, 9), ("!?", LeftAssoc, 9), ("++", RightAssoc, 5), ("\\\\", NoAssoc, 5), ("elem", NoAssoc, 4), ("notElem", NoAssoc, 4)]
    , entry "GHC.Internal.Data.List.NonEmpty"
        [(":|", RightAssoc, 5)]
    , entry "GHC.Internal.Data.Maybe" []
    , entry "GHC.Internal.Data.Monoid"
        [("<>", RightAssoc, 6)]
    , entry "GHC.Internal.Data.NonEmpty"
        [(":|", RightAssoc, 5)]
    ...
    , entry "GHC.Internal.PrimopWrappers"
