...
--
-- Not by hand. The boot packages\' sources were unpacked, every module they
-- expose was enumerated from the compiler\'s own package database, and GHC
-- itself was asked for the fixity of every operator each module exports.
-- Asking GHC rather than reading @infix@ declarations is what makes
-- re-exports come out right: @($)@ is declared in an internal module and
-- exported by "Prelude", and only the compiler knows the whole chain.
--
-- An operator can have different fixities in different modules — @(\\\\)@ is
-- @infix 5@ in "Data.List" and @infixl 9@ in "Data.Map" — which is why this
-- is keyed by module and not by operator.
module Linden.Fixity.Builtin
  ( builtinFixities,
  )
where
...
builtinFixities =
  Map.fromList
    ...
    , entry "Control.DeepSeq"
        [("$!!", RightAssoc, 0), ("<$!!>", LeftAssoc, 4)]
    ...
    , entry "Data.Bits"
        [("!<<.", LeftAssoc, 8), ("!>>.", LeftAssoc, 8), (".&.", LeftAssoc, 7), (".<<.", LeftAssoc, 8), (".>>.", LeftAssoc, 8), (".^.", LeftAssoc, 6), (".|.", LeftAssoc, 5)]
    , entry "Data.Bool"
        [("&&", RightAssoc, 3), ("||", RightAssoc, 2)]
    , entry "Data.ByteString"
        [("!?", LeftAssoc, 9)]
    , entry "Data.ByteString.Builder" []
    , entry "Data.ByteString.Builder.Extra" []
    , entry "Data.ByteString.Builder.Internal" []
    , entry "Data.ByteString.Builder.Prim"
        [(">$<", LeftAssoc, 4), (">*<", RightAssoc, 5)]
    , entry "Data.ByteString.Builder.Prim.Internal"
        [(">$<", LeftAssoc, 4), (">*<", RightAssoc, 5)]
    , entry "Data.ByteString.Builder.RealFloat" []
    , entry "Data.ByteString.Char8"
        [("!?", LeftAssoc, 9)]
    , entry "Data.ByteString.Internal" []
    , entry "Data.ByteString.Lazy"
        [("!?", LeftAssoc, 9)]
    , entry "Data.ByteString.Lazy.Char8"
        [("!?", LeftAssoc, 9)]
    , entry "Data.ByteString.Lazy.Internal" []
    , entry "Data.ByteString.Short"
        [("!?", LeftAssoc, 9)]
    , entry "Data.ByteString.Short.Internal"
        [("!?", LeftAssoc, 9)]
    ...
    , entry "Data.Map.Strict"
        [("!", LeftAssoc, 9), ("!?", LeftAssoc, 9), ("\\\\", LeftAssoc, 9)]
    , entry "Data.Map.Strict.Internal"
        [("!", LeftAssoc, 9), ("!?", LeftAssoc, 9), ("\\\\", LeftAssoc, 9)]
    , entry "Data.Maybe" []
    , entry "Data.Monoid"
        [("<>", RightAssoc, 6)]
    ...
    , entry "Data.Semigroup"
        [("<>", RightAssoc, 6)]
    , entry "Data.Sequence"
        [("!?", LeftAssoc, 9), (":<", RightAssoc, 5), (":>", LeftAssoc, 5), ("<|", RightAssoc, 5), ("><", RightAssoc, 5), ("|>", LeftAssoc, 5)]
    , entry "Data.Sequence.Internal"
        [("!?", LeftAssoc, 9), (":<", RightAssoc, 5), (":>", LeftAssoc, 5), ("<|", RightAssoc, 5), ("><", RightAssoc, 5), ("|>", LeftAssoc, 5)]
    , entry "Data.Sequence.Internal.Sorting" []
    , entry "Data.Set"
        [("\\\\", LeftAssoc, 9)]
    , entry "Data.Set.Internal"
        [("\\\\", LeftAssoc, 9)]
    , entry "Data.String" []
    , entry "Data.Text" []
    ...
    , entry "Data.Text.Internal.Fusion.Types"
        [(":*:", LeftAssoc, 2)]
    ...
    , entry "Data.Time.Format.Internal" []
    , entry "Data.Time.LocalTime" []
    , entry "Data.Traversable" []
    , entry "Data.Tree" []
    , entry "Data.Tuple" []
    , entry "Data.Type.Bool" []
    , entry "Data.Type.Coercion" []
    , entry "Data.Type.Equality" []
    , entry "Data.Type.Ord" []
    , entry "Data.Typeable" []
    , entry "Data.Unique" []
    , entry "Data.Version" []
    ...
    , entry "GHC.Base"
        [("$", RightAssoc, 0), ("$!", RightAssoc, 0), ("&&", RightAssoc, 3), ("*#", LeftAssoc, 7), ("*##", LeftAssoc, 7), ("**##", LeftAssoc, 9), ("*>", LeftAssoc, 4), ("+#", LeftAssoc, 6), ("+##", LeftAssoc, 6), ("++", RightAssoc, 5), ("-#", LeftAssoc, 6), ("-##", LeftAssoc, 6), (".", RightAssoc, 9), ("/##", LeftAssoc, 7), ("/=", NoAssoc, 4), ("/=#", NoAssoc, 4), ("/=##", NoAssoc, 4), (":|", RightAssoc, 5), ("<", NoAssoc, 4), ("<#", NoAssoc, 4), ("<##", NoAssoc, 4), ("<$", LeftAssoc, 4), ("<*", LeftAssoc, 4), ("<**>", LeftAssoc, 4), ("<*>", LeftAssoc, 4), ("<=", NoAssoc, 4), ("<=#", NoAssoc, 4), ("<=##", NoAssoc, 4), ("<>", RightAssoc, 6), ("<|>", LeftAssoc, 3), ("=<<", RightAssoc, 1), ("==", NoAssoc, 4), ("==#", NoAssoc, 4), ("==##", NoAssoc, 4), (">", NoAssoc, 4), (">#", NoAssoc, 4), (">##", NoAssoc, 4), (">=", NoAssoc, 4), (">=#", NoAssoc, 4), (">=##", NoAssoc, 4), (">>", LeftAssoc, 1), (">>=", LeftAssoc, 1), ("||", RightAssoc, 2)]
    , entry "GHC.Bits"
        [(".&.", LeftAssoc, 7), (".|.", LeftAssoc, 5)]
    , entry "GHC.ByteOrder" []
    , entry "GHC.CString" []
    , entry "GHC.Char" []
    , entry "GHC.Classes"
    ...
    , entry "GHC.ExecutionStack.Internal" []
    , entry "GHC.Exts"
        [("*#", LeftAssoc, 7), ("*##", LeftAssoc, 7), ("**##", LeftAssoc, 9), ("+#", LeftAssoc, 6), ("+##", LeftAssoc, 6), ("-#", LeftAssoc, 6), ("-##", LeftAssoc, 6), ("/##", LeftAssoc, 7), ("/=#", NoAssoc, 4), ("/=##", NoAssoc, 4), ("<#", NoAssoc, 4), ("<##", NoAssoc, 4), ("<=#", NoAssoc, 4), ("<=##", NoAssoc, 4), ("==#", NoAssoc, 4), ("==##", NoAssoc, 4), (">#", NoAssoc, 4), (">##", NoAssoc, 4), (">=#", NoAssoc, 4), (">=##", NoAssoc, 4)]
    ...
    , entry "GHC.Internal.Arr"
        [("!", LeftAssoc, 9), ("//", LeftAssoc, 9)]
    , entry "GHC.Internal.ArrayArray" []
    , entry "GHC.Internal.Base"
        [("$", RightAssoc, 0), ("$!", RightAssoc, 0), ("&&", RightAssoc, 3), ("*#", LeftAssoc, 7), ("*##", LeftAssoc, 7), ("**##", LeftAssoc, 9), ("*>", LeftAssoc, 4), ("+#", LeftAssoc, 6), ("+##", LeftAssoc, 6), ("++", RightAssoc, 5), ("-#", LeftAssoc, 6), ("-##", LeftAssoc, 6), (".", RightAssoc, 9), ("/##", LeftAssoc, 7), ("/=", NoAssoc, 4), ("/=#", NoAssoc, 4), ("/=##", NoAssoc, 4), (":|", RightAssoc, 5), ("<", NoAssoc, 4), ("<#", NoAssoc, 4), ("<##", NoAssoc, 4), ("<$", LeftAssoc, 4), ("<*", LeftAssoc, 4), ("<**>", LeftAssoc, 4), ("<*>", LeftAssoc, 4), ("<=", NoAssoc, 4), ("<=#", NoAssoc, 4), ("<=##", NoAssoc, 4), ("<>", RightAssoc, 6), ("<|>", LeftAssoc, 3), ("=<<", RightAssoc, 1), ("==", NoAssoc, 4), ("==#", NoAssoc, 4), ("==##", NoAssoc, 4), (">", NoAssoc, 4), (">#", NoAssoc, 4), (">##", NoAssoc, 4), (">=", NoAssoc, 4), (">=#", NoAssoc, 4), (">=##", NoAssoc, 4), (">>", LeftAssoc, 1), (">>=", LeftAssoc, 1), ("||", RightAssoc, 2)]
    , entry "GHC.Internal.Bits"
        [(".&.", LeftAssoc, 7), (".|.", LeftAssoc, 5)]
    ...
    , entry "GHC.Internal.Data.Bits"
        [("!<<.", LeftAssoc, 8), ("!>>.", LeftAssoc, 8), (".&.", LeftAssoc, 7), (".<<.", LeftAssoc, 8), (".>>.", LeftAssoc, 8), (".^.", LeftAssoc, 6), (".|.", LeftAssoc, 5)]
    , entry "GHC.Internal.Data.Bool"
        [("&&", RightAssoc, 3), ("||", RightAssoc, 2)]
    , entry "GHC.Internal.Data.Coerce" []
    , entry "GHC.Internal.Data.Data" []
    , entry "GHC.Internal.Data.Dynamic" []
    , entry "GHC.Internal.Data.Either" []
    , entry "GHC.Internal.Data.Enum" []
    , entry "GHC.Internal.Data.Eq"
        [("/=", NoAssoc, 4), ("==", NoAssoc, 4)]
    , entry "GHC.Internal.Data.Foldable"
        [("elem", NoAssoc, 4), ("notElem", NoAssoc, 4)]
    , entry "GHC.Internal.Data.Function"
        [("$", RightAssoc, 0), ("&", LeftAssoc, 1), (".", RightAssoc, 9)]
    , entry "GHC.Internal.Data.Functor"
        [("$>", LeftAssoc, 4), ("<$", LeftAssoc, 4), ("<$>", LeftAssoc, 4), ("<&>", LeftAssoc, 1)]
    , entry "GHC.Internal.Data.Functor.Const" []
    , entry "GHC.Internal.Data.Functor.Identity" []
    , entry "GHC.Internal.Data.Functor.Utils"
        [("#.", LeftAssoc, 9)]
    , entry "GHC.Internal.Data.IORef" []
    , entry "GHC.Internal.Data.Ix" []
    , entry "GHC.Internal.Data.List"
        [("!!", LeftAssoc, 9), ("!?", LeftAssoc, 9), ("++", RightAssoc, 5), ("\\\\", NoAssoc, 5), ("elem", NoAssoc, 4), ("notElem", NoAssoc, 4)]
    , entry "GHC.Internal.Data.Maybe" []
    , entry "GHC.Internal.Data.Monoid"
        [("<>", RightAssoc, 6)]
    , entry "GHC.Internal.Data.OldList"
        [("!!", LeftAssoc, 9), ("!?", LeftAssoc, 9), ("++", RightAssoc, 5), ("\\\\", NoAssoc, 5)]
    , entry "GHC.Internal.Data.Ord"
        [("<", NoAssoc, 4), ("<=", NoAssoc, 4), (">", NoAssoc, 4), (">=", NoAssoc, 4)]
    ...
    , entry "GHC.Internal.Data.Type.Bool" []
    , entry "GHC.Internal.Data.Type.Coercion" []
    , entry "GHC.Internal.Data.Type.Equality" []
    , entry "GHC.Internal.Data.Type.Ord" []
    , entry "GHC.Internal.Data.Typeable" []
    , entry "GHC.Internal.Data.Unique" []
    , entry "GHC.Internal.Data.Version" []
    , entry "GHC.Internal.Data.Void" []
    , entry "GHC.Internal.Debug.Trace" []
    , entry "GHC.Internal.Desugar"
        [(">>>", LeftAssoc, 9)]
    ...
    , entry "GHC.Internal.IO.SubSystem"
        [("<!>", LeftAssoc, 7)]
    , entry "GHC.Internal.IO.Unsafe" []
    , entry "GHC.Internal.IOArray" []
    , entry "GHC.Internal.IOPort" []
    ...
    , entry "GHC.Internal.Text.ParserCombinators.ReadP"
        [("+++", RightAssoc, 5), ("<++", RightAssoc, 5)]
    , entry "GHC.Internal.Text.ParserCombinators.ReadPrec"
        [("+++", LeftAssoc, 9), ("<++", LeftAssoc, 9)]
    , entry "GHC.Internal.Text.Read"
        [("+++", LeftAssoc, 9), ("<++", LeftAssoc, 9)]
    , entry "GHC.Internal.Text.Read.Lex" []
    , entry "GHC.Internal.Text.Show" []
    , entry "GHC.Internal.TopHandler" []
    , entry "GHC.Internal.Type.Reflection" []
    , entry "GHC.Internal.Type.Reflection.Unsafe" []
    , entry "GHC.Internal.TypeError"
        [(":$$:", LeftAssoc, 5), (":<>:", LeftAssoc, 6)]
    , entry "GHC.Internal.TypeLits"
        [(":$$:", LeftAssoc, 5), (":<>:", LeftAssoc, 6)]
    , entry "GHC.Internal.TypeLits.Internal" []
    , entry "GHC.Internal.TypeNats" []
    ...
    , entry "GHC.TypeLits"
        [(":$$:", LeftAssoc, 5), (":<>:", LeftAssoc, 6)]
    , entry "GHC.TypeLits.Internal" []
    , entry "GHC.TypeNats" []
    , entry "GHC.TypeNats.Internal" []
    , entry "GHC.Types" []
    , entry "GHC.Unicode" []
    , entry "GHC.Weak" []
    ...
    , entry "Language.Haskell.TH.CodeDo"
        [(">>", LeftAssoc, 1), (">>=", LeftAssoc, 1)]
    , entry "Language.Haskell.TH.LanguageExtensions" []
    , entry "Language.Haskell.TH.Lib" []
    , entry "Language.Haskell.TH.Lib.Internal" []
    , entry "Language.Haskell.TH.Ppr" []
    , entry "Language.Haskell.TH.PprLib"
        [("$$", LeftAssoc, 5), ("$+$", LeftAssoc, 5), ("<+>", LeftAssoc, 6), ("<>", RightAssoc, 6)]
    ...
    , entry "System.FilePath.Posix"
        [("-<.>", RightAssoc, 7), ("<.>", RightAssoc, 7), ("</>", RightAssoc, 5)]
    , entry "System.FilePath.Windows"
        [("-<.>", RightAssoc, 7), ("<.>", RightAssoc, 7), ("</>", RightAssoc, 5)]
    , entry "System.IO" []
    ...
    , entry "System.OsPath.Posix"
        [("-<.>", LeftAssoc, 9), ("<.>", LeftAssoc, 9), ("</>", LeftAssoc, 9)]
    , entry "System.OsPath.Posix.Internal"
        [("-<.>", RightAssoc, 7), ("<.>", RightAssoc, 7), ("</>", RightAssoc, 5)]
    , entry "System.OsPath.Types" []
    , entry "System.OsPath.Windows"
        [("-<.>", LeftAssoc, 9), ("<.>", LeftAssoc, 9), ("</>", LeftAssoc, 9)]
    , entry "System.OsPath.Windows.Internal"
        [("-<.>", RightAssoc, 7), ("<.>", RightAssoc, 7), ("</>", RightAssoc, 5)]
    , entry "System.OsString"
        [("!?", LeftAssoc, 9)]
    , entry "System.OsString.Data.ByteString.Short"
        [("!?", LeftAssoc, 9)]
    , entry "System.OsString.Data.ByteString.Short.Internal" []
    , entry "System.OsString.Data.ByteString.Short.Word16"
        [("!?", LeftAssoc, 9)]
    , entry "System.OsString.Encoding" []
    , entry "System.OsString.Encoding.Internal" []
    , entry "System.OsString.Internal"
        [("!?", LeftAssoc, 9)]
    , entry "System.OsString.Internal.Exception" []
    , entry "System.OsString.Internal.Types" []
    , entry "System.OsString.Posix"
        [("!?", LeftAssoc, 9)]
    , entry "System.OsString.Windows"
        [("!?", LeftAssoc, 9)]
    , entry "System.Posix" []
    , entry "System.Posix.ByteString" []
    ...
    , entry "System.Posix.PosixString" []
    ...
    , entry "System.Posix.Signals" []
    , entry "System.Posix.Signals.Exts" []
    ...
    , entry "Text.ParserCombinators.Parsec.Perm"
        [("<$$>", LeftAssoc, 2), ("<$?>", LeftAssoc, 2), ("<|?>", LeftAssoc, 1), ("<||>", LeftAssoc, 1)]
    , entry "Text.ParserCombinators.Parsec.Pos" []
    , entry "Text.ParserCombinators.Parsec.Prim"
        [("<?>", NoAssoc, 0), ("<|>", RightAssoc, 1)]
    , entry "Text.ParserCombinators.Parsec.Token" []
    , entry "Text.ParserCombinators.ReadP"
        [("+++", RightAssoc, 5), ("<++", RightAssoc, 5)]
    , entry "Text.ParserCombinators.ReadPrec"
        [("+++", LeftAssoc, 9), ("<++", LeftAssoc, 9)]
    , entry "Text.PrettyPrint"
        [("$$", LeftAssoc, 5), ("$+$", LeftAssoc, 5), ("<+>", LeftAssoc, 6), ("<>", RightAssoc, 6)]
    , entry "Text.PrettyPrint.Annotated"
        [("$$", LeftAssoc, 5), ("$+$", LeftAssoc, 5), ("<+>", LeftAssoc, 6), ("<>", RightAssoc, 6)]
    , entry "Text.PrettyPrint.Annotated.HughesPJ"
        [("$$", LeftAssoc, 5), ("$+$", LeftAssoc, 5), ("<+>", LeftAssoc, 6), ("<>", RightAssoc, 6)]
    , entry "Text.PrettyPrint.Annotated.HughesPJClass"
        [("$$", LeftAssoc, 5), ("$+$", LeftAssoc, 5), ("<+>", LeftAssoc, 6), ("<>", RightAssoc, 6)]
    , entry "Text.PrettyPrint.HughesPJ"
        [("$$", LeftAssoc, 5), ("$+$", LeftAssoc, 5), ("<+>", LeftAssoc, 6), ("<>", RightAssoc, 6)]
    , entry "Text.PrettyPrint.HughesPJClass"
        [("$$", LeftAssoc, 5), ("$+$", LeftAssoc, 5), ("<+>", LeftAssoc, 6), ("<>", RightAssoc, 6)]
    , entry "Text.Printf" []
    , entry "Text.Read"
        [("+++", LeftAssoc, 9), ("<++", LeftAssoc, 9)]
    ...
    , entry "Unsafe.Coerce" []
    , entry "Utils.Containers.Internal.BitQueue" []
    , entry "Utils.Containers.Internal.BitUtil" []
    , entry "Utils.Containers.Internal.StrictPair"
        [(":*:", RightAssoc, 1)]
    ]
  where
    entry name ops =
